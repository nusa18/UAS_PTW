...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="{{ asset('js/AdminLTE/dist/css/adminlte.min.css') }}">
  <!-- Ionicons -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        @else
            <img src="{{ asset('images/icon-profile.png ') }}" alt="User Image" class="img-circle elevation-2" >
        @endif
        </div>
        <div class="info">
...
<!-- AdminLTE App -->
<script src="{{ asset('js/AdminLTE/dist/js/adminlte.min.js') }}"></script>
</body>
</html>